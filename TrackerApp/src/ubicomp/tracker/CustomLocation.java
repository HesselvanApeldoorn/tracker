...
public class CustomLocation {
	...
	public enum CustomLocationType{type1, type2, type3, typeX}
	...
	public boolean Overlap(CustomLocation _location) {
		...
		currentLocation.setLatitude(_location.markeroptions.getPosition().latitude);
		currentLocation.setLongitude(_location.markeroptions.getPosition().longitude);
